    ...
    function init(){
      ...
      alertsHTML += '<div id="divWrappers" class="collapse in">';
        ...
        $('#collapserLink').click(function(e){
            ...
            if($('#collapser').hasClass("fa-caret-square-o-down")){
                $("#collapser").removeClass("fa-caret-square-o-down").addClass("fa-caret-square-o-up");
            } else {
                $("#collapser").removeClass("fa-caret-square-o-up").addClass("fa-caret-square-o-down");
            }
